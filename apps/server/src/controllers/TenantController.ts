...
export class TenantController {
  ...
  static async getAllTenants(c: Context) {
    try {
      console.log("📥 TenantController.getAllTenants - Requisição recebida");

      const tenants = await TenantController.tenantService.getAllTenants();
      console.log("📤 TenantController.getAllTenants - Resposta do service:", {
        success: tenants.success,
        count: tenants.data?.length || 0,
      });

      return c.json(
        { ...tenants, message: "Tenants listados com sucesso" },
        tenants.success ? 200 : 500
      );
    } catch (error) {
      console.error(
        "💥 TenantController.getAllTenants - Erro capturado:",
        error
      );
      return c.json({ success: false, error: "Erro ao listar tenants" }, 500);
    }
  }
  ...
  static async getTenantById(c: Context) {
    try {
      ...
      console.log("📥 TenantController.getTenantById - ID recebido:", id);

      const tenant = await TenantController.tenantService.getTenantById(id);
      console.log("📤 TenantController.getTenantById - Resposta do service:", {
      ...
      console.error(
        "💥 TenantController.getTenantById - Erro capturado:",
        error
      );
  ...
  static async createTenant(c: Context) {
    try {
      ...
      console.log("📥 TenantController.createTenant - Payload recebido:", data);

      const tenant = await TenantController.tenantService.createTenant(data);
      console.log("📤 TenantController.createTenant - Resposta do service:", {
        success: tenant.success,
        error: tenant.error,
        hasData: !!tenant.data,
      });
      ...
      console.error(
        "💥 TenantController.createTenant - Erro capturado:",
        error
      );
  ...
  static async updateTenant(c: Context) {
    try {
      ...
      console.log("📤 TenantController.updateTenant - Resposta do service:", {
        success: tenant.success,
        error: tenant.error,
        hasData: !!tenant.data,
      });
      ...
      console.error(
        "💥 TenantController.updateTenant - Erro capturado:",
        error
      );
  ...
  static async deleteTenant(c: Context) {
    try {
      const id = c.req.param("id");
      console.log("📥 TenantController.deleteTenant - ID recebido:", id);

      const deleted = await TenantController.tenantService.deleteTenant(id);
      console.log("📤 TenantController.deleteTenant - Resposta do service:", {
      ...
      console.error(
        "💥 TenantController.deleteTenant - Erro capturado:",
        error
      );
      ...
      return c.json(
        {
          ...
          message: roles.success
            ? "Roles do tenant listadas com sucesso"
            : roles.error || "Erro ao buscar roles",
        },
  ...
  static async getTenantInvitations(c: Context) {
    try {
      ...
      return c.json(
        {
          ...invitations,
          message: invitations.success
            ? "Convites do tenant listados com sucesso"
            : invitations.error || "Erro ao buscar convites",
        },
      ...
      return c.json(
        {
          ...
          message: invitation.success
            ...
            : invitation.error || "Erro ao criar convite",
        },
      ...
      return c.json(
        {
          ...
          message: result.success
            ...
            : result.error || "Convite não encontrado",
        },
  ...
  static async cancelInvitation(c: Context) {
    try {
      ...
      const result = await TenantController.tenantService.cancelInvitation({
        tenantId,
        invitationId,
      });
      return c.json(
      ...
      return c.json(
        {
          ...
          message: result.success
            ...
            : result.error || "Erro ao atribuir role",
        },
  ...
  static async removeUserRole(c: Context) {
    try {
      const tenantId = c.req.param("id");
      const data = await c.req.json();
      const result = await TenantController.tenantService.removeUserRole({
        ...data,
        tenantId,
      });
      return c.json(
        {
          ...
          message: result.success
            ...
            : result.error || "Erro ao remover role",
        },
        result.success ? 200 : 400
      );
    } catch (error) {
